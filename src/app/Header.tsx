        ...
        <HeaderContainer>
            <TopHeaderContainer>
                ...
                <LinksTop>
                    ...
                    <LinkTop>Подарочные сертификаты</LinkTop>
                    <LinkTop>Помощь</LinkTop>
                    <LinkTop>Пункты выдачи</LinkTop>
                </LinksTop>
            </TopHeaderContainer>
            <MiddleHeaderContainer scroll={scroll}>
                ...
                <Search>
                    <Magnifier />
                    <InputSearch placeholder="Найти на СВОЙ" />
                </Search>
            ...
            <BottomHeaderContainer scroll={scroll}>
                <LinkBottom>Одежда и обувь</LinkBottom>
                <LinkBottom>Электроника</LinkBottom>
                <LinkBottom>Дом и сад</LinkBottom>
                <LinkBottom>Детские товары</LinkBottom>
                <LinkBottom>Продукты питания</LinkBottom>
                <LinkBottom>Красота и здоровье</LinkBottom>
                <LinkBottom>Услуги</LinkBottom>
